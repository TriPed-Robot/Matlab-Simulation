function [theta0,theta1, theta2] = inverseKinematics(A)
...
[OptVals,fval,~,output] = fmincon(@closingWay0toTarget,guessVals,[],[],[],[],[],[],@constrainsWay0,options)
...
% pass values from way0 to function for minimizing the other ways.
global globala0 globalb0 globalc0 globald0;
globala0 = a0;
globalb0 = b0;
globalc0 = c0;
globald0 = d0;
...
[OptVals,fval,~,output] = fmincon(@closingEqWithGivenWay0,guessVals,[],[],[],[],[],[],@constrainsWays1_2,options)
theta1 = OptVals(1);
theta2 = OptVals(10);
...
% todo: pass parameters the right way!

function [error] = closingWay0toTarget(GUESSEDVALS)
...
[Aa,Ab,Ac,Ad, Ax,Ay,Az] = getValuesfromHomogenMatrix(globalMatA);
...
function [error] = closingEqWithGivenWay0(GUESSEDVALS)
...
global globala0 globalb0 globalc0 globald0; %  get a0,...,d0 from function above, without changing them via fminunc

A = Weg0(globala0,globalb0,globalc0,globald0);
